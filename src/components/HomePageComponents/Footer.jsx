    ...
    >
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <div className="d-flex flex-column justify-content-start">
            <a className="text-white mb-2" href="#"
              ><i className="fa fa-angle-right mr-2"></i>Mi familia</a
            >
            <a className="text-white mb-2" href="#"
              ><i className="fa fa-angle-right mr-2"></i>Mis papás</a
            >
            <a className="text-white" href="#"
              ><i className="fa fa-angle-right mr-2"></i>Baby Shower</a
            >
          </div>
        </div>
      </div>
      ...
      >
        <p className="m-0 text-center text-white">
          &copy;
          <a className="text-primary font-weight-bold" href="#">https://atlasaviel.me</a>.
